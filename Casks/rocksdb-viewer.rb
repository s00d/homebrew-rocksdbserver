cask "rocksdb-viewer" do
  ...
  url "https://github.com/s00d/RocksDBFusion/releases/download/app-v0.0.2/rocksdb-viewer_0.0.2_x64.dmg", if Hardware::CPU.intel?
  url "https://github.com/s00d/RocksDBFusion/releases/download/app-v0.0.2/rocksdb-viewer_0.0.2_aarch64.dmg", if Hardware::CPU.arm?
